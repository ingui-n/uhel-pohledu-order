...
<button type="button" class="btn btn-primary" <?php echo $orderBox ? 'id="open-order-form"' : '' ?>data-toggle="modal" data-target="#exampleModalCenter">Koupit knihu</button>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <button type="button" class="close <?php echo $showOrder ? 'reload' : ''; ?>" data-dismiss="modal" aria-label="Close">
