...
if (($order->isOrderSent() && $order->getValidationFailed()) || $order->getOrderedFromSession()) {
    $orderBox = true;
}
...
<button type="button" class="btn btn-primary" <?php echo $orderBox ? 'id="open-order-form"' : '' ?>data-toggle="modal"
        data-target="#exampleModalCenter">Koupit knihu
</button>
        ...
        <div class="modal-content">
            <form method="post" name="order">
                <div class="modal-header">
                    ...
                    <button type="button" class="close <?php echo $showOrder ? 'reload' : ''; ?>" data-dismiss="modal"
                            aria-label="Close">
                ...
                <div class="modal-body">
                            ...
                            <div class="form-text-inputs">
                                ...
                                <div>
                                    <input type="text" name="order[town]"
                                           class="form-item <?php echo $order->getValidationError(6) ? 'error-input' : ''; ?>"
                                           id="town"
                                ...
                                <div>
                                    <input type="text" name="order[phone-number]"
                                           ...
                                           value="<?php echo $values['phone-number'] ?? '' ?>">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary <?php echo $showOrder ? 'reload' : ''; ?>"
